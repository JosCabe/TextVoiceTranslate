...
class TextoAVoz:
    ...
    def reproducir(self):
        try:
            ...
            # Ventana emergente para preguntar si eliminar archivos tras reproducir
            tk.Tk().withdraw()
           ...
           # Eliminar archivos si el usuario aceptó
            if respuesta:
...
# Este script permite ingresar texto desde diferentes fuentes (manual, archivo o URL),
# detecta su idioma automáticamente, da la opción de traducirlo a varios idiomas soportados
# (es, en, fr, it, de, tr, zh), puede generar un resumen si el texto tiene más de 100 palabras,
...
- Resume automáticamente textos largos (más de 99 palabras)
